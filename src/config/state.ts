...
export const STATE_INIT: State = {
  ...
  build: BUILD,
  authState: {
    // Приоритет мобильной версии на открытие логина по номеру: IS_MOBILE ? 'authStateSignIn' : 'authStateSignQr'
    // Изменён на автоматическое открытие логина по номеру в любом случае
    _: 'authStateSignIn'
  },
